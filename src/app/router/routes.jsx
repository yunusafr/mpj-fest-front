...
import RegistrationDetailPage from "@/features/registration/pages/RegistrationDetailPage";
import SubmissionPage from "@/features/participant/pages/SubmissionPage";
import AdminEventsPage from "@/features/super-admin/admin-events/pages/AdminEventsPage";
import SubmissionsPage from "@/features/admin-event/pages/SubmissionsPage";
import AdminEventDashboard from "@/features/admin-event/pages/DashboardPage";
import AssignEventPage from "@/features/super-admin/admin-events/pages/AssignEventPage";
import CreateAdminEventPage from "@/features/super-admin/admin-events/pages/CreateAdminEventPage";
import SubmissionDetailPage from "@/features/admin-event/pages/SubmissionDetailPage";
import FestivalListPage from "@/features/super-admin/festivals/pages/FestivalListPage";

import CreateFestivalPage from "@/features/super-admin/festivals/pages/CreateFestivalPage";

import EditFestivalPage from "@/features/super-admin/festivals/pages/EditFestivalPage";
...
import TicketPage from "@/features/ticket/pages/TicketPage";
import ScanTicketPage from "@/features/admin-event/pages/ScanTicketPage";

import JudgesPage from "@/features/super-admin/judges/pages/JudgesPage";

import AssignJudgePage from "@/features/super-admin/judges/pages/AssignJudgePage";
import CreateJudgePage from "@/features/super-admin/judges/pages/CreateJudgePage";
...
export const routes = [
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: ":id/assign",
            element: <AssignJudgePage />,
          },
          {
            path: "create",

            element: <CreateJudgePage />,
          },
          {
            path: ":id/edit",

            element: <EditJudgePage />,
          },
        ],
      },
  ...
  },
  {
    ...
    element: (
      <ProtectedRoute>
        <RoleRoute allowedRoles={["admin_event"]}>
          <DashboardLayout />
        </RoleRoute>
      </ProtectedRoute>
    ),
  ...
  },
  {
    ...
    element: (
      <ProtectedRoute>
        <RoleRoute allowedRoles={["peserta"]}>
          <DashboardLayout />
        </RoleRoute>
      </ProtectedRoute>
    ),
