...
import { useAdminCertificateDetail } from "../hooks/useAdminCertificates";

export default function AdminCertificatePage() {
  const { eventId } = useParams();

  const { data, isLoading, error } = useAdminCertificateDetail(eventId);
  ...
  const config = cert?.sertifikat_config ?? {};
