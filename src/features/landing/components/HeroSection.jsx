      ...
      <div className="container relative mx-auto px-6">
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          "
            >
              Festival
              <span className="gradient-text block">Media Pondok</span>
              Jawa Timur
            </h1>

            <p className="mt-8 max-w-xl text-lg text-slate-600">
              Wadah kreativitas santri dalam bidang jurnalistik, fotografi,
              videografi, desain grafis, media digital, dan karya kreatif
              berbasis teknologi.
            </p>
          ...
          "
            >
              <h3 className="text-xl font-bold">{festival?.nama}</h3>
