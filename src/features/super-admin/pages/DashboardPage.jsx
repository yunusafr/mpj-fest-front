...
import { Calendar, Users, Vote, CalendarDays, Sparkles } from "lucide-react";
              ...
              <div className="mt-6 space-y-4">
                {recentActivities.map((activity) => {
                  ...
                  return (
                    <div
                      key={activity.id}
                      className="group flex gap-4 rounded-xl p-3 transition hover:bg-emerald-50/40"
                    >
                      {/* dot */}
                      <div className="mt-2 flex h-3 w-3 items-center justify-center">
                        <div
                          className="h-2.5 w-2.5 rounded-full group-hover:scale-125 transition"
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2">
                          <p className="font-bold" style={{ color: "#064622" }}>
            ...
            {summary.length === 0 ? (
              <div className="flex min-h-[240px] flex-col items-center justify-center text-center">
                <div
                  ...
                  style={{ backgroundColor: "rgba(6,70,34,.08)" }}
                >
                  <div
...
function SummaryItem({ label, value }) {
  return (
    <div>
      ...
      <p className="mt-1 text-3xl font-black" style={{ color: "#064622" }}>
        {value}
      </p>
    </div>
  );
